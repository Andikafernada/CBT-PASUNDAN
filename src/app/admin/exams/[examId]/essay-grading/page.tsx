        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {qAnswers.filter((a) => a.isAiGraded).length > 0 && (
            <button
              ...
              className="px-4 py-2 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white rounded-xl text-xs font-black shadow-md shadow-emerald-600/20 flex items-center gap-1.5 transition cursor-pointer disabled:opacity-50"
              title="Sahkan seluruh nilai rekomendasi AI untuk butir soal ini menjadi nilai resmi guru"
            >
              {isApprovingAll ? (
          ...
          <button
            ...
            disabled={isBatchGrading || unGradedCount === 0}
            className="px-4 py-2 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white rounded-xl text-xs font-black shadow-md shadow-purple-600/20 flex items-center gap-2 transition cursor-pointer disabled:opacity-50"
            title="Koreksi otomatis seluruh jawaban yang belum dinilai menggunakan AI"
          >
            {isBatchGrading ? (
              <>
                <div className="w-3.5 h-3.5 border-2 border-white border-t-transparent rounded-full animate-spin" />
              ...
              <>
                ...
                <span>🤖 Koreksi Otomatis AI ({unGradedCount})</span>
              </>
            )}
          </button>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-2 border-b border-sky-200">
                  ...
                  <div className="flex items-center gap-2">
                    {item.isAiGraded ? (
                      <span className="px-2 py-0.5 rounded-full text-[10px] font-black bg-purple-100 text-purple-950 border border-purple-300 flex items-center gap-1">
                        <Sparkles className="w-3 h-3 text-purple-700" />
                        <span>Dinilai AI</span>
                      </span>
                    ) : isGraded ? (
