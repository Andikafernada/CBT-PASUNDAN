...
export default function LegacyImportPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-black text-slate-900 dark:text-black tracking-tight">Migrasi Database ZYACBT Legacy</h1>
      ...
      <div className="p-4 rounded-2xl bg-blue-500/10 border border-blue-500/20 flex items-start gap-3 text-xs text-blue-300">
        ...
        <div className="leading-relaxed">
          <span className="font-bold text-slate-900 dark:text-black">Kompatibilitas Penuh:</span> Parser modern ini secara otomatis membaca tabel `cbt_modul`, `cbt_topik`, `cbt_soal`, `cbt_jawaban`, `cbt_user`, dan mengonversinya ke skema modern ZYACBT Next-Gen.
        </div>
      </div>
      ...
      <div className="glass p-6 space-y-5">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            <h3 className="font-bold text-sm text-slate-900 dark:text-black">Pilih File Dump Database (.sql)</h3>
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
              File `zyacbt-public-2024-05-05-tanpa-database.sql` atau file backup ZYACBT lainnya.
            </p>
          </div>

          <label className="px-4 py-2 bg-sky-100 hover:bg-slate-700 text-slate-200 rounded-xl text-xs font-semibold cursor-pointer transition border border-slate-200 dark:border-sky-200">
        ...
        {file && (
          <div className="p-3 bg-slate-50 dark:bg-sky-50 rounded-xl border border-slate-200 dark:border-sky-200 text-xs text-slate-700 dark:text-slate-300 flex items-center justify-between">
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full p-3.5 bg-slate-50 dark:bg-sky-50 border border-slate-200 dark:border-sky-200 rounded-xl font-mono text-[11px] text-slate-700 dark:text-slate-300 focus:outline-none focus:border-blue-500 leading-relaxed resize-y"
          />
        </div>
      ...
      {stats && (
        <div className="p-6 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 space-y-4 animate-in zoom-in-95">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <div className="p-3 bg-sky-50 rounded-xl border border-slate-200 dark:border-sky-200 text-center">
              <div className="text-xl font-black text-slate-900 dark:text-black">{stats.topics}</div>
          ...
          <div className="flex gap-2 pt-2">
            ...
            <button
              ...
              className="px-4 py-2 bg-sky-100 hover:bg-slate-700 text-slate-200 font-semibold text-xs rounded-xl transition"
            >
              Buat Ujian Baru
            </button>
          </div>
