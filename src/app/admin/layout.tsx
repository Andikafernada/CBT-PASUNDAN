        ...
        <div className="flex flex-col h-full min-h-0">
          ...
          <div className="h-16 px-4 border-b border-slate-200 flex items-center justify-between shrink-0 bg-slate-50/70">
            <div className="flex items-center gap-2.5">
              <div className="relative w-9 h-9 rounded-xl bg-blue-600 flex items-center justify-center text-white shadow-xs shrink-0">
                <GraduationCap className="w-5 h-5" />
              </div>
              <div className="min-w-0">
                <div className="flex items-center gap-1.5">
                  <span className="font-bold text-xs text-slate-900 tracking-tight truncate">CBT HEBAT</span>
                  <span
                ...
                <p className="text-[10px] text-slate-500 font-medium truncate">SMK Pasundan 2 Bandung</p>
              </div>
            </div>
          ...
          <div className="p-3 border-t border-slate-200 bg-slate-50/70 shrink-0">
            ...
            <div className="pt-1.5 border-t border-slate-200/80 text-[10px] text-slate-400 font-medium text-center">
              CBT HEBAT • <span className="font-semibold text-slate-600">SMK Pasundan 2</span>
            </div>
          </div>
        </div>
      </aside>
