...
console.log("🚀 Menerapkan perbaikan waktu & token ke Proxmox CT 601...");
...
echo "🧹 Membersihkan sesi pengujian lama di Database..."
node -e "
...
async function clean() {
  ...
  console.log(\\"✅ Sesi database telah dibersihkan!\\");
